...
<head>
    ...
    <link rel="stylesheet" href="https://raw.githack.com/Junzlay/neumorph-age-calculator/main/footer.css">
</head>
<!-- <link rel="stylesheet" href="proxy.php?link=https://raw.githubusercontent.com/Junzlay/neumorph-age-calculator/main/footer.css"> -->
<script>
        ...
        <div class="row justify-content-center align-items-center h-100">
            <div class="col col-sm-6 col-md-6 col-lg-4 col-xl-3">
                <form action="" method="POST" class="w-100">
                    ...
                    <p class="text-center name small text-light mt-5 font-italic text-nowrap"><?= isset($_POST['submit']) ? $data : '' ?></p>
                </form>
